...
async def render_page(id, secure_hash):
    ...
    <img src="https://i.postimg.cc/L4xq42xt/mxlogo-1-removebg-preview.png" alt="MX PLAYER Logo" style="max-width: 130px; height: 40px; display: block; margin: 0 auto;">
    </button>
...
<button style="display: inline-block; border-radius: 5px; border: none; cursor: pointer; padding: 2px auto; text-align: center; text-decoration: none; background-color: #c0e0ff; overflow: hidden;" onclick="window.location.href = 'vlc://{current_url}'">
    <img src="https://i.postimg.cc/tCs9xqp5/1000029028-removebg-preview.png" alt="MX PLAYER Logo" style="max-width: 130px; height: 40px; display: block; margin: 0 auto;">
</button>

<!-- Add another line space here -->
