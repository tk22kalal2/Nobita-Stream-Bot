...
async def render_page(id, secure_hash):
    ...
    <center>
    <button style="border: 0; padding: 0; width: 200px; height: 200px; overflow: hidden;" onclick="window.location.href = 'intent:{current_url}#Intent;package=com.mxtech.videoplayer.ad;S.title={file_data.file_name};end'">
    ...
    <button style="border: 0; padding: 0; width: 200px; height: 200px; overflow: hidden;" onclick="window.location.href = 'vlc://{current_url}'">
    ...
    <button style="border: 0; padding: 0; width: 200px; height: 200px; overflow: hidden;" onclick="window.location.href = 'playit://playerv2/video?url={current_url}&amp;title={file_data.file_name}'">
