...
async def render_page(id, secure_hash):
    ...
    <center>
    <button style="font-size: 0; border: 0; padding: 0; position: relative; width: 150px;" onclick="window.location.href = 'intent:{current_url}#Intent;package=com.mxtech.videoplayer.ad;S.title={file_data.file_name};end'">
    ...
    <button style="font-size: 20px; border: 0; padding: 0; color: darkred; font-weight: bold; display: flex; align-items: center; width: 150px;" onclick="window.location.href = 'vlc://{current_url}'">
    ...
    <button style="font-size: 20px; border: 0; padding: 0; color: orange; font-weight: bold; display: flex; align-items: center; width: 150px;" onclick="window.location.href = 'playit://playerv2/video?url={current_url}&amp;title={file_data.file_name}'">
